...
const TOKEN = '';
...
function uploadFile(filePath, type, version, remark) {
  return new Promise((resolve, reject) => {
    ...
    const contentType = isApk ? 'application/vnd.android.package-archive' : 'application/octet-stream';
