    ...
    texts: state => {
      const zh = {
        login: {
          ...
          // 新增字段
          authFailed: '授权失败',
          googleNotSupported: '暂不支持Google登录',
          appleNotAvailable: 'Apple登录暂不可用',
          configFetchFailed: '配置获取失败',
        ...
        create: {
          ...
          saveImageFileFailed: '保存图片文件失败',
          parseImageDataFailed: '解析图片数据失败',
          getModelLinkFailed: '获取模型链接失败',
        ...
        explore: {
          ...
          confirmCancel: '确认取消',
          cancelContent: '取消后将不自动打印，模型处理将在后台继续，是否确认？',
          ...
          enterContent: '请输入内容',
          imageSelected: '已选择图片',
          stlFileSelected: '已选择STL文件',
          categorySelected: '已选择分类',
          ...
          sliceFailed: '切片失败',
          sliceFailedContent: '模型切片处理失败，请稍后重试或联系客服',
          loadModelInfoFailed: '加载模型信息失败',
          pleaseAddDevice: '请先添加设备',
          sendFailed: '发送失败',
          noAvailableDevice: '暂无可用设备',
          deviceIdNotFound: '设备ID不存在',
          confirmPausePrint: '确认暂停打印？',
          pausing: '暂停中...',
          printPaused: '打印已暂停',
          confirmResumePrint: '确认恢复打印？',
          resuming: '恢复中...',
          printResumed: '打印已恢复',
          cancelPrint: '取消打印',
          confirmCancelPrint: '确认取消打印？此操作不可撤销。',
          stopping: '正在停止...',
          printCancelled: '已取消打印',
          stopPrintFailed: '停止失败，请重试',
          missingRequiredParams: '缺少必要参数',
          confirmRestartPrint: '确认重新开始打印？',
          restarting: '重启中...',
          printRestarted: '已重新开始打印',
          paramError: '参数错误',
          modelGenerateFailed: '模型生成失败',
          ...
          saving: '保存中...',
          cancelling: '正在取消...',
          sendingPrintCommand: '正在发送打印指令...',
          shareSuccess: '分享成功',
          shareFailed: '分享失败',
          shareNotAvailable: '分享功能暂不可用',
          linkCopied: '链接已复制',
          ...
          tip: '提示',
          reportSuccess: '举报成功',
          modelIdNotFound: '模型ID不存在',
          confirmDeleteModel: '确定要删除这个模型吗？删除后无法恢复。',
          confirmDeleteModelContent: '确定要删除当前模型吗？',
          deleting: '删除中...',
          modelCentered: '模型已居中',
          modelFitted: '模型已适配',
          autoScaled: '模型已自动缩放至99mm',
          modelOutOfBounds: '模型边缘超出边界，请调整',
          getDeviceInfoFailed: '获取设备信息失败，请检查打印机连接',
          copySuccess: '复制成功',
          connectionFailed: '连接失败',
          connectionFailedContent: '无法建立实时连接，请检查网络后重试',
          deviceBusy: '设备忙',
          deviceBusyContent: '设备正在打印中，请先停止当前任务',
          deviceOffline: '设备离线',
          deviceOfflineContent: '设备当前离线，请检查设备连接状态',
        ...
        deviceManager: {
          ...
          save: '保存',
          cancel: '取消',
          noWifiFound: '未发现可用的WiFi，请检查路由器是否开启',
          wifiSearchFailed: '未能搜索到周边WiFi，请重试',
          editDeviceName: '修改设备名称',
          enterNewDeviceName: '请输入新的设备名称',
          editRemark: '修改备注',
          enterDeviceRemark: '请输入设备备注',
          editSuccess: '修改成功',
          editFailed: '修改失败',
          deviceIdNotFound: '设备ID不存在',
          confirmUnbind: '确认解除绑定',
          confirmUnbindContent: '解除绑定后将无法控制此打印机，确定要继续吗？',
          unbindSuccess: '已解除绑定',
        ...
        addDevice: {
          ...
          failed: '获取失败，点击重试',
          select: '选择',
          noWiFiRetry: '无WiFi，点击重试',
          stopScan: '停止扫描',
          enterWiFiPassword: '请输入WiFi密码',
          tips: '请确保连接的家庭WiFi网络为2.4G网络',
          nextStep: '下一步',
          networking: '配网中...',
          gettingWiFiList: '获取WiFi列表...',
          noWiFiFound: '未发现可用的WiFi，请检查路由器是否开启',
          searchWiFiFailed: '未能搜索到周边WiFi，请重试',
          scanStopped: '扫描已停止',
          pleaseSelectWiFi: '请选择WiFi',
          pleaseEnterPassword: '请输入WiFi密码',
          checkingDevice: '检查设备连接...',
          deviceConnectFailed: '设备连接失败，请靠近设备后重试',
          networkConfigSuccess: '配网成功',
          networkConfigFailed: '配网失败',
        ...
        printerMoreIntro: {
          title: '打印机设置',
          calibrationTitle: '校准功能',
          autoLevel: '自动调平',
          autoLevelDesc: '自动检测并调整打印平台',
          zOffset: 'Z轴偏移',
          zOffsetDesc: '调整喷嘴与打印平台距离',
          extruderCalibration: '挤出机校准',
          extruderCalibrationDesc: '校准挤出机步进电机',
          startCalibration: '开始校准',
          nameLabel: '名称',
          remarkLabel: '备注',
          clickToAddRemark: '点击添加备注',
          snLabel: 'SN',
          reconfigure: '重新配网',
          unbind: '解除绑定',
          unbindFailed: '解除绑定失败',
          firmwareSettings: '固件设置',
          ...
          nozzleLife: '喷嘴寿命',
          lastClean: '上次清洁',
          totalPrintTime: '累计打印时长',
          binding: '正在绑定设备...',
          pleaseWait: '请稍候',
          bindingFailed: '绑定失败',
          bindingFailedHint: '设备绑定未成功，请检查网络后重试',
          retryBind: '重新绑定',
          selectWiFiToConnect: '请选择要连接的WiFi',
          onlySupport24G: '该设备仅支持2.4GWiFi网络',
          hours: '小时',
          bindingSuccess: '绑定成功'
        },
        printer: {
      ...
      const en = {
        login: {
          ...
          googleNotSupported: 'Google login not supported yet',
          appleNotAvailable: 'Apple login not available',
        ...
        create: {
          ...
          imageGenerateFailed: 'Image generation failed, please try again',
          ...
          saveImageFileFailed: 'Failed to save image file',
          parseImageDataFailed: 'Failed to parse image data',
          getModelLinkFailed: 'Failed to get model link',
        ...
        explore: {
          ...
          loading: 'Loading...',
          loadWorkDetailFailed: 'Failed to load task details',
          ...
          stlFileSelected: 'STL file selected',
          ...
          sliceFailed: 'Slicing failed',
          sliceFailedContent: 'Model slicing failed, please try again later or contact support',
          loadModelInfoFailed: 'Failed to load model info',
          pleaseAddDevice: 'Please add a device first',
          sendFailed: 'Send failed',
          noAvailableDevice: 'No available devices',
          deviceIdNotFound: 'Device ID not found',
          confirmPausePrint: 'Confirm pause printing?',
          pausing: 'Pausing...',
          ...
          stopPrintFailed: 'Failed to stop, please try again',
          missingRequiredParams: 'Missing required parameters',
          confirmRestartPrint: 'Confirm restart printing?',
          restarting: 'Restarting...',
          printRestarted: 'Print restarted',
          paramError: 'Parameter error',
          modelGenerateFailed: 'Model generation failed',
          generateTimeout: 'Generation timeout, please check later',
          queryFailed: 'Query failed',
          generateCancelled: 'Generation cancelled',
          cancelFailed: 'Cancel failed',
          imageUploadInDev: 'Image upload feature is under development',
          parsing: 'Parsing...',
          uploading: 'Uploading...',
          saving: 'Saving...',
          ...
          shareFailed: 'Share failed',
          shareNotAvailable: 'Share feature is not available',
          ...
          confirmDeleteModel: 'Are you sure you want to delete this model? This cannot be undone.',
          confirmDeleteModelContent: 'Are you sure you want to delete the current model?',
          deleting: 'Deleting...',
          modelCentered: 'Model centered',
          modelFitted: 'Model fitted',
          autoScaled: 'Model auto-scaled to 99mm',
          modelOutOfBounds: 'Model edge out of bounds, please adjust',
        ...
        deviceManager: {
          ...
          noWifiFound: 'No available WiFi found, please check if the router is on',
          wifiSearchFailed: 'Failed to search for nearby WiFi, please try again',
          editDeviceName: 'Edit Device Name',
          enterNewDeviceName: 'Enter new device name',
          editRemark: 'Edit Remark',
          enterDeviceRemark: 'Enter device remark',
          ...
          install: 'Install',
          complete: 'Complete',
          pleaseGoToAppStore: 'Please go to app store to update',
          normal: 'Normal',
          outdated: 'Outdated',
          corrupted: 'Corrupted',
          verified: 'Verified',
        ...
        addDevice: {
          ...
          selectWiFi: 'Please select WiFi',
          scanning: 'Scanning...',
          stopped: 'Stopped, tap to rescan',
          failed: 'Failed to get, tap to retry',
          select: 'Select',
          noWiFiRetry: 'No WiFi, tap to retry',
          stopScan: 'Stop Scan',
          enterWiFiPassword: 'Enter WiFi password',
          tips: 'Please ensure your home WiFi network is 2.4G',
          nextStep: 'Next',
          networking: 'Configuring network...',
          gettingWiFiList: 'Getting WiFi list...',
          noWiFiFound: 'No available WiFi found, please check if router is on',
          searchWiFiFailed: 'Failed to search nearby WiFi, please retry',
          scanStopped: 'Scan stopped',
          pleaseSelectWiFi: 'Please select WiFi',
          pleaseEnterPassword: 'Please enter WiFi password',
          checkingDevice: 'Checking device connection...',
          deviceConnectFailed: 'Device connection failed, please get closer and retry',
          networkConfigSuccess: 'Network config success',
          networkConfigFailed: 'Network config failed',
        ...
        printerMoreIntro: {
          ...
          autoLevelDesc: 'Automatically detect and adjust print platform',
          zOffset: 'Z Offset',
          zOffsetDesc: 'Adjust nozzle distance from print platform',
          extruderCalibration: 'Extruder Calibration',
          extruderCalibrationDesc: 'Calibrate extruder stepper motor',
          startCalibration: 'Start Calibration',
          nameLabel: 'Name',
          remarkLabel: 'Remark',
          clickToAddRemark: 'Click to add remark',
          snLabel: 'SN',
          reconfigure: 'Reconfigure Network',
          unbind: 'Unbind',
          unbindFailed: 'Unbind failed',
          ...
          filamentLife: 'Filament Life',
          nozzleLife: 'Nozzle Life',
          lastClean: 'Last Clean',
          totalPrintTime: 'Total Print Time',
          binding: 'Binding device...',
          pleaseWait: 'Please wait',
          bindingFailed: 'Binding failed',
          bindingFailedHint: 'Device binding failed, please check network and retry',
          retryBind: 'Retry Binding',
          selectWiFiToConnect: 'Please select WiFi to connect',
          onlySupport24G: 'This device only supports 2.4G WiFi network',
          hours: 'hours',
        ...
        printer: {
          ...
          deviceIdNotFound: 'Device ID Not Found',
          confirmUnbind: 'Confirm Unbind',
          confirmUnbindContent: 'After unbinding, you will not be able to control this printer. Continue?',
