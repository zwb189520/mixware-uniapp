...
import { BlurPass, EffectComposer, KernelSize } from 'postprocessing'
import { MeshReflectorMaterial as MeshReflectorMaterialImpl } from '../materials/MeshReflectorMaterial.js'
import { useThreeJs } from '../../'

const { useLoop, useDispose, getInstance } = useThreeJs()
...
class MeshReflectorMaterial {
  ...
  _beforeRender(parent) {
    ...
    this.target
      .subVectors(this.reflectorWorldPosition, this.lookAtPosition)
      .reflect(this.normal)
      .negate()
      .add(this.reflectorWorldPosition)
