import { MeshRefractionMaterial as MeshRefractionMaterialImpl } from '../materials/MeshRefractionMaterial.js'
...
class MeshRefractionMaterial {
  constructor({ aberrationStrength = 0, fastChroma = true, envMap, ...props } = {}) {
    // 创建材质实例
  ...
  initialize(geometry) {
    ...
    const { renderer, camera } = getInstance()
