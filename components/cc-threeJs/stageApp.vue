<template>
  <view
    class="w-full h-full relative stage-app-touch"
    :prop="$props"
    :callParam="callParam"
    :change:callParam="three.callSelfMethod"
    :change:prop="three.init"
    @click.stop=""
  >
    <div id="container" class="w-full h-full container-touch" @click="three.handleClick"></div>
    <!-- 自己写逻辑可以这样调用方法比较方便。 -->
